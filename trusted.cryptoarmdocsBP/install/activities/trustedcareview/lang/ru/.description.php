<?
$MESS ['BPAR_DESCR_NAME'] = "КриптоАРМ Документы: ознакомление с документом";
$MESS ['BPAR_DESCR_DESCR'] = "Ознакомление с документом с проверкой подписи и возможностью оставить отзыв на него.";
